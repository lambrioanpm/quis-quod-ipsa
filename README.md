...
[![Build Status](https://circleci.com/gh/blackflux/@lambrioanpm/quis-quod-ipsa.png?style=shield)](https://circleci.com/gh/blackflux/@lambrioanpm/quis-quod-ipsa)
[![NPM](https://img.shields.io/npm/v/@lambrioanpm/quis-quod-ipsa.svg)](https://www.npmjs.com/package/@lambrioanpm/quis-quod-ipsa)
[![Downloads](https://img.shields.io/npm/dt/@lambrioanpm/quis-quod-ipsa.svg)](https://www.npmjs.com/package/@lambrioanpm/quis-quod-ipsa)
[![Size](https://shields.io/badge/min%20+%20gz-5.00%20KB-informational)](https://bundlephobia.com/package/@lambrioanpm/quis-quod-ipsa)
...
Using npm:
    ...
    $ npm i @lambrioanpm/quis-quod-ipsa

In a browser:

```html
<script type="module">
  import objectScan from 'https://cdn.jsdelivr.net/npm/@lambrioanpm/quis-quod-ipsa@<VERSION>/lib/index.min.js';
  // do logic here
</script>
```
...
```js
import objectScan from '@lambrioanpm/quis-quod-ipsa';
...
- Dependency free and [tiny bundle size](https://cdn.jsdelivr.net/npm/@lambrioanpm/quis-quod-ipsa/lib/)
...
This syntax allows for `key` result of @lambrioanpm/quis-quod-ipsa to be passed back into itself.
...
but it can be said that `@lambrioanpm/quis-quod-ipsa` is more versatile at similar performance.

|   |[objectScan](https://www.npmjs.com/package/@lambrioanpm/quis-quod-ipsa) (compiled)|[objectScan](https://www.npmjs.com/package/@lambrioanpm/quis-quod-ipsa)|[nimma](https://www.npmjs.com/package/nimma) (compiled)|[nimma](https://www.npmjs.com/package/nimma)|[jsonpath-plus](https://www.npmjs.com/package/jsonpath-plus)|[jsonpath](https://www.npmjs.com/package/jsonpath)|[jmespath](https://www.npmjs.com/package/jmespath)|
|---|---|---|---|---|---|---|---|
...
Noteworthy [dependents](https://github.com/lambrioanpm/quis-quod-ipsa/network/dependents) are:
...
Many other examples can be found on [Stack Overflow](https://stackoverflow.com/search?q=%5Bjavascript%5D+@lambrioanpm/quis-quod-ipsa+user%3A1030413).
